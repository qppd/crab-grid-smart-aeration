...
| 8 | **Aeration capacity** | ⚠️ 8 cages ≈ 320 L total → target approximately 4.8–6.4 L/min delivered (1.5–2 L/min per 100 L). Each MPQ-03 is rated 68 L/min open-flow at 35W, so 2 units give N+1 redundancy and alternating duty, not because each cage needs a full pump. Use valves/manifolds and measure each branch. |
